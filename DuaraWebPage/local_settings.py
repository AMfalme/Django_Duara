"""
Django settings for DuaraWebPage project.
...
WSGI_APPLICATION = 'DuaraWebPage.wsgi.application'
...
SERVER_EMAIL = 'mfalmegriffin@163.com'  # 
EMAIL_HOST_USER = 'mfalmegriffin@163.com'  # 
